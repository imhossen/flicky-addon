...
class Cards extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Flicky Cards', 'flicky-addon' );
	}
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'John Doe.', 'flicky-addon' ),
				'placeholder' => __( 'Type your title here', 'flicky-addon' ),
			]
		);
        $repeater->add_control(
			'card_subtitle',
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Web Designer', 'flicky-addon' ),
				'placeholder' => __( 'Type sub title here.', 'flicky-addon' ),
			]
		);
        $repeater->add_control(
			'card_description',
